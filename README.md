...
**功能**：工作室正文按“商品与原图、分析与确认、创意方向、素材生成、交付与迭代”5 个用户阶段聚焦展示；顶部状态中心持续追踪原图理解、商品策略、方向规划、Prompt Pack、素材生成、质量评价、发布文案和导出素材 8 个技术节点。
...
**功能**：项目创建后，商品名称、类别、目标平台、风格偏好、目标人群和核心卖点集中在商品简报中，原图作为后续所有阶段的保真参考。
...
**功能**：CopywritingAgent 围绕选中图片生成多平台发布文案；交付阶段同时提供自然语言修改、重新评分以及 Markdown / JSON 导出。
